...
import { ArrowLeft, Package, Printer, RefreshCw, Trash2 } from "lucide-react";
...
export default function Page() {
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 gap-5 mb-6">
      {/* ── Header ── */}
      <div className="pb-2 border-b border-default-200 flex items-start justify-between gap-3 flex-col sm:flex-row">
        <div>
      ...
      <div style={{ display: "none" }}>
        {order && settings && (
          <InvoiceTemplate ref={printRef} order={order} settings={settings} />
        )}
      </div>
