...
- [x] **API GET LIST** — ketika ada inputan baru tampilkan data baru diatas.
- [x] **Antrian Desain** — ketika update status ke produksi muncul form spk.
...
- [ ] **Fitur Custom Harga** — menambahkan fitur custom harga pada inputan pesanan.
...
- [ ] **Dashboard Keuangan** — .
- [ ] **Laporan Neraca** — perbarui api mengambil data yang sudah dikoreksi jika ada reversal data.
...
- [ ] **Invoice Rekening** — web setting tambahkan setting rekening yang muncul pada invoice berdasarkan data tabel kasbank.
- [ ] **Image Upload** — image product.
- [ ] **Hapus Fitur reversal** — hapus fitur reversal.
